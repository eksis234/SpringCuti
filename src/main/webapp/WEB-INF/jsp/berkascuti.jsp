            ...
            <main class="mdl-layout__content mdl-color--grey-100">
                <div class="mdl-grid demo-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9">
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/tambah5" role="button"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
                            </div><!-- /.col-lg-6 -->
                            <div class="col-lg-3">
                                    ...
                                    <tbody>
                                        <c:forEach items="${berkascutis}" var="berkascuti">
                                            <tr>
                                                ...
                                                <td><a href="${pageContext.request.contextPath}/edit5/${karyawan.id}"><span class="glyphicon glyphicon-edit"></span></a> | 
                                                    <a href="${pageContext.request.contextPath}/delete5/${karyawan.id}"><span class="glyphicon glyphicon-trash"></span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
