            ...
            <main class="mdl-layout__content mdl-color--grey-100">
                <div class="mdl-grid demo-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9">
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/tambah1" role="button"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
                            </div><!-- /.col-lg-6 -->
                        </div><!-- /.row -->
                        <br>
                        <div class="card">
                                    ...
                                    <tbody>
                                        <c:forEach items="${departemens}" var="departemen">
                                            <tr>
                                                ...
                                                <td><a href="${pageContext.request.contextPath}/edit1/${karyawan.id}"><span class="glyphicon glyphicon-edit"></span></a> | 
                                                    <a href="${pageContext.request.contextPath}/delete1/${karyawan.id}"><span class="glyphicon glyphicon-trash"></span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
