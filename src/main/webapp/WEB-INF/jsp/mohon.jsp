            ...
            <main class="mdl-layout__content mdl-color--grey-100">
                <div class="mdl-grid demo-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9">
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/tambah6" role="button"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
                            </div><!-- /.col-lg-6 -->
                            <div class="col-lg-3">
                                    ...
                                    <tbody>
                                        <c:forEach items="${permohonans}" var="permohonan">
                                            <tr>
                                                ...
                                                <td><a href="${pageContext.request.contextPath}/edit6/${permohonan.idPermohonan}"><span class="glyphicon glyphicon-edit"></span></a> | 
                                                    <a href="${pageContext.request.contextPath}/delete6/${permohonan.idPermohonan}"><span class="glyphicon glyphicon-trash"></span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
